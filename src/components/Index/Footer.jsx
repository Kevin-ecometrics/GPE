...
function Footer() {
  ...
  return (
    <div className="md:container mx-auto py-8 px-8 md:px-0">
        ...
        {URL === "/" ||
          (URL === "/home" && (
            <div className="flex justify-between flex-col md:flex-row items-start md:items-center">
              <h1 className="text-4xl md:text-6xl uppercase mb-4 md:mb-0">
      ...
      <div className="flex flex-col md:flex-row justify-between items-center gap-4 md:gap-0 py-4 md:px-4">
